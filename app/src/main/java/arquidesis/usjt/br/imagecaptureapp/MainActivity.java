...
public class MainActivity extends AppCompatActivity implements ImageInputHelper.ImageActionListener{
    ...
    public Bitmap doFilter(Bitmap bitmap){
        ...
        switch(v.getId()){
            case 0:
                return imageProcessor.doHighlightImage(bitmap);
                break;
            case 1:
                return imageProcessor.doInvert(bitmap);
                break;
            case 2:
                return imageProcessor.doGamma(bitmap);
                break;
            case 3:
                return imageProcessor.doColorFilter(bitmap);
                break;
            case 4:
                return imageProcessor.createSepiaToningEffect(bitmap);
                break;
            case 5:
                return imageProcessor.decreaseColorDepth(bitmap);
                break;
